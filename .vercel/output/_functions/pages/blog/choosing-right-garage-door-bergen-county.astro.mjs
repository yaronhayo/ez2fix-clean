...
const $$ChoosingRightGarageDoorBergenCounty = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Best Garage Doors for Bergen County NJ Homes | Expert Guide | Ez2Fix Licensed Contractor", "description": "Complete guide to choosing the right garage door for Bergen County NJ homes. Compare materials, styles, insulation for NJ weather. Expert advice from licensed contractor Ez2Fix. Steel vs wood vs aluminum options for Fair Lawn, Elmwood Park, Clifton homes.", "keywords": "best garage doors bergen county nj, garage door selection guide bergen county, garage door materials nj, garage door styles bergen county, choosing garage door new jersey weather, insulated garage doors bergen county, steel garage doors nj, wood garage doors bergen county, garage door installation guide nj" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeaderClean", $$HeaderClean, {})} ${maybeRenderHead()}<main id="main-content"> <!-- Article Header --> <section class="py-16" style="background: linear-gradient(135deg, #1D1912 0%, #2A2420 100%);"> <div class="container mx-auto px-4"> <div class="max-w-4xl mx-auto"> <div class="text-center mb-8"> <span class="px-4 py-2 rounded-full text-sm font-semibold" style="background: rgba(238, 205, 92, 0.2); color: #EECD5C;">
Installation
...
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fix-clean/src/pages/blog/choosing-right-garage-door-bergen-county.astro", void 0);

const $$file = "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fix-clean/src/pages/blog/choosing-right-garage-door-bergen-county.astro";
