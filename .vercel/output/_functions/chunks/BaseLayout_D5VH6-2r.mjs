import { f as createComponent, m as maybeRenderHead, p as renderScript, r as renderTemplate, e as createAstro, k as renderComponent, n as renderSlot, o as renderHead, u as unescapeHTML, h as addAttribute, l as Fragment } from './astro/server_BJwJjVcz.mjs';
import 'kleur/colors';
import { c as clientEnv } from './env_dT-QYl02.mjs';
import 'clsx';
/* empty css                               */
...
const $$ScrollToTop = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<button id="scroll-to-top" class="fixed top-1/2 right-6 z-40 w-12 h-12 bg-ez2fix-primary text-ez2fix-dark rounded-full shadow-premium hover:shadow-xl transition-all duration-300 hover:scale-110 opacity-0 invisible translate-y-4 hover:bg-ez2fix-primary/90 focus:outline-none focus:ring-2 focus:ring-ez2fix-primary focus:ring-offset-2" style="transform: translateY(25vh);" aria-label="Scroll to top" title="Scroll to top" data-astro-cid-hnzwq3ap> <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-hnzwq3ap> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" data-astro-cid-hnzwq3ap></path> </svg> </button> ${renderScript($$result, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fix-clean/src/components/ui/ScrollToTop.astro?astro&type=script&index=0&lang.ts")}  `;
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fix-clean/src/components/ui/ScrollToTop.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template([`<html lang="en" data-astro-cid-37fxchfa> <head><!-- Google Tag Manager --><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How much does garage door repair cost in Bergen County NJ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Garage door repair costs vary by issue. We provide free estimates with upfront pricing - no hidden fees. Most repairs range from $150-$400."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer 24/7 emergency garage door repair?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! Ez2Fix provides 24/7 emergency garage door repair service throughout Bergen County. Call (201) 554-6769 anytime."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Garage door springs typically last 7-10 years or 10,000 cycles. Warning signs include loud noises, door won't open, or closes too fast."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! Ez2Fix is fully licensed (#13VH13553300) and insured for all garage door work in New Jersey. We're BBB A+ rated."
        }
      }
    ]
  })), unescapeHTML(JSON.stringify({
  ...
  })), renderHead(), renderSlot($$result, $$slots["default"]), renderComponent($$result, "ScrollToTop", $$ScrollToTop, { "data-astro-cid-37fxchfa": true }));
}, "/Users/yaronhayo/Dev_Projects/Projects_2025/ez2fix-clean/src/layouts/BaseLayout.astro", void 0);
